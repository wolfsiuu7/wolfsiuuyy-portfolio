...
<<<<<<< HEAD
  ...
  {
    id: 4,
    title: "Musculation Ou Cardio ? Tu fais fausse route",
    tag: "SHORT-FORM",
    ytId: "JlLMgXP4F3E",
    thumb: "https://i.ytimg.com/vi/JlLMgXP4F3E/maxresdefault.jpg",
    meta: "YOUTUBE SHORTS • @Wolfsiuu7 • HD",
    desc: "High-retention short-form edit — punchy cuts, dynamic captions and sound design engineered to hold attention from the first frame.",
...
<<<<<<< HEAD
      <div className="flex flex-1 flex-col justify-between gap-3 p-4">
        ...
        <div className="flex items-center justify-between gap-3">
          <span className="mono text-[10px] tracking-widest text-[#E9EEFC]/50 truncate group-hover:text-[#9DB1FF] transition-colors">
            {work.tag}
          </span>
